...
Route::group(['middleware' => ['jwt.verify']], function () {
    ...
    Route::get('/user/{userId}/articulo/{nombreArticulo}/monto-total', [ComprobanteController::class, 'getTotalAmountByArticle']); // Monto total por artículo de un usuario en específico  
    Route::get('/user/{userId}/comprobantes/monto/total', [ComprobanteController::class, 'getTotalAmount']); // Monto total acumulado por todos los comprobantes de un usuario específico
